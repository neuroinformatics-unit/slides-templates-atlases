...
- Publish on a public repository and document
- Make it easy to use (API?)
:::
...
## Population average templates

The naive way: register and average the brains

Types of registration (feature-based vs intensity-based)

## How to make an unbiased average

The Fonov 2011 method

Two contraints:
- minimise MSE between each transformed image and the template
- minimise the deformation field
